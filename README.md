...
The `mangrove` monorepo contains most of the TypeScript (and JavaScript) packages developed for the Mangrove. The core contracts and market making strat library for Mangrove lives in the [https://github.com/mangrovedao/mangrove-core]
