...
class OfferLogic {
   ...
   * @param tokenSymbolOrId the token symbol or id to activate.
  ...
  activate(
    ...
    const tokenAddress = this.mgv.getTokenAddress(tokenSymbolOrId);
    return this.contract.activate(tokenAddress, overrides);
  }
