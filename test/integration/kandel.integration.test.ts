...
//         priceParams: { minPrice: 900, stepSize: 1.01, pricePoints: 6 },
//         midPrice: 1000,
//         initialAskGives: 1,
//       });
//     });
...
//           assert.equal(params.stepSize, 0, "ratio should be default");
...
//       const abMarket = await mgv.market({
//         base: "TokenA",
//         quote: "TokenB",
//         tickSpacing: 1,
//       });
//       const wethDaiMarket = await mgv.market({
//         base: "WETH",
//         quote: "DAI",
//         tickSpacing: 1,
//       });
//       const wethUsdcMarket = await mgv.market({
//         base: "WETH",
//         quote: "USDC",
//         tickSpacing: 1,
//       });
...
//       const kandels = await farm.getKandels({
//         olKeyStruct: { base: "WETH", quote: "USDC", tickSpacing: 1 },
//       });
//       assert.equal(kandels.length, 3, "count wrong");
//     });
//     // This cannot be done anymore. We need to use the olKeyHash to filter.
...
//             );
//             // FIXME: fix when distribution is return Tick
//             // assert.equal(
...
//         // assert.equal(
//         //   statuses.statuses[0].bids?.tick?.toNumber(),
//         //   900,
...
//         assert.equal(
//           statuses.statuses[4].asks?.tick?.round(0).toString(),
//           "1360"
//         );
//       });
...
//         assert.equal(
//           singleOfferDistribution.stepSize,
//           parameters.stepSize
//         );
//         assert.equal(
...
//             gives: offer.gives,
//           }));
//         // FIXME: fix when distribution uses Tick
...
//         const pricePoints = 6;
//         const distribution = kandel.generator.calculateDistribution({
//           priceParams: { minPrice: 1000, stepSize, pricePoints },
//           midPrice: 1200,
//           initialAskGives,
//         });
