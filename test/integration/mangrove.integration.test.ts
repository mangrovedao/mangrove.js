...
describe("Mangrove integration tests suite", function () {
  ...
  describe("calculateOLKeyHash", () => {
    it("agrees with hash generated by events and cache", async () => {
      // Arrange
      const olKey = {
      ...
      const hashFromEvent = mgv.olKeyStructToOlKeyHashMap.get(cacheKey);
      const hashFromCache = mgv.getOlKeyHash(olKey);
