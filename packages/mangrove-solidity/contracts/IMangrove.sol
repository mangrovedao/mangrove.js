...
import {MgvLib as ML, IMaker} from "./MgvLib.sol";
...
interface IMangrove {
  ...
  function configInfo(address outbound_tkn, address inbound_tkn)
    external
    view
    returns (P.GlobalStruct memory global, LocalStruct memory local);
  ...
  function isLive(offerT offer) external pure returns (bool);
