...
import {MgvLib, IMaker, Structs} from "./MgvLib.sol";
...
interface IMangrove {
  ...
  function config(address outbound_tkn, address inbound_tkn) external view returns (Structs.GlobalPacked, Structs.LocalPacked);
  ...
  function isLive(Structs.OfferPacked offer) external pure returns (bool);
